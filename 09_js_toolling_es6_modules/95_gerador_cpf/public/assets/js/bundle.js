...
(function () {
  function getButton() {
    var btnNewCPF = document.querySelector('.btn-new-cpf');

    if (btnNewCPF) {
      var cpf = new _modules_GeneratorCPF__WEBPACK_IMPORTED_MODULE_0__["default"]();
      var newCPF = document.querySelector('.cpf-gerado');
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return GeneratorCPF; });
...
var GeneratorCPF = /*#__PURE__*/function () {
  ...
  _createClass(GeneratorCPF, [{
    ...
    value: function createNewCPF() {
      var partialCPF = this.rand();
      var firstDigit = _ValidateCPF__WEBPACK_IMPORTED_MODULE_0__["default"].createDigit(partialCPF);
      var secondDigit = _ValidateCPF__WEBPACK_IMPORTED_MODULE_0__["default"].createDigit(partialCPF + firstDigit);
      var newCPF = partialCPF + firstDigit + secondDigit;
      return _ValidateCPF__WEBPACK_IMPORTED_MODULE_0__["default"].formatCPF(newCPF);
    }
  }]);
...
var ValidateCPF = /*#__PURE__*/function () {
  function ValidateCPF(cpf) {
    ...
    Object.defineProperty(this, 'cleanCPF', {
      ...
      //Não pode escrever
      enumerable: true,
      //True: irá aparecer no console.log
      configurable: false,
  ...
  _createClass(ValidateCPF, [{
    ...
    value: function validate() {
      ...
      var partialCPF = this.partialCPF();
      var firstDigit = ValidateCPF.createDigit(partialCPF);
      var secondDigit = ValidateCPF.createDigit(partialCPF + firstDigit);
      var newCPF = partialCPF + firstDigit + secondDigit;
      return newCPF === this.cleanCPF;
    }
  }], [{
    key: "formatCPF",
    value: function formatCPF(paramCPF) {
    ...
    value: function createDigit(partialCPF) {
      var sumDigit = 0;
      var countdown = partialCPF.length + 1;

      var _iterator = _createForOfIteratorHelper(partialCPF),
          _step;
